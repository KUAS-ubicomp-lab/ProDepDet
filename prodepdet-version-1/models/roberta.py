...
class PromptRoberta(nn.Module):
    ...
    def init_prompt_emb(self, init_ids):
        self.backbone.roberta.embeddings.init_prompt_emb(torch.tensor(init_ids, dtype=torch.long),
                                                         self.backbone.roberta.embeddings.word_embeddings)
    ...
    def forward(
        ...
        attention_mask, token_type_ids = self.backbone.roberta.embeddings.prepend_attention_mask(attention_mask,
                                                                                                 token_type_ids)
